...
#     """
#     필터링된 폴리곤, 섹터, 최적 클러스터 중심에 파란색 원을 추가한 클러스터링 결과 시각화 함수.
...
#             # 최적의 클러스터 ID와 일치하는 폴리곤에 파란색 원 추가
#             if cluster_label == optimal_cluster_id:
#                 centroid = filtered_data.iloc[polygon_idx]['centroid']
#                 circle = Circle((centroid.x, centroid.y), radius=0.001, color='blue', fill=False, linewidth=2)
#                 ax.add_patch(circle)
