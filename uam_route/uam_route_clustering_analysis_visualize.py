...
cluster_polygon_count_stats = results_df['Optimal_Cluster_Polygon_Count'].agg(['mean', 'min', 'max'])
...
ax1.set_ylabel('Number of Candidates', fontsize=20)
...
ax2.plot(
    ...
    linewidth=2,
    color='blue',
    label='Cluster Area (km²)'
)

ax2.set_ylabel('Distance (km) / Cluster Area (km²)', fontsize=20)
